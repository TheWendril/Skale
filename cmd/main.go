...
import (
	...
	"github.com/TheWendril/Skale/internal/controller"
...
func main() {
	...
	flag.BoolVar(&secureMetrics, "metrics-secure", true, "Serve metrics endpoint securely via HTTPS.")
	...
	if err != nil {
		setupLog.Error(err, "não foi possível criar MetricsClient")
		os.Exit(1)
	}
	...
	mgr, err := ctrl.NewManager(cfg, ctrl.Options{
		...
		LeaderElectionID:       "1de364af.skale.io",
	})
	if err != nil {
	...
	if err = (&controller.SkaleReconciler{
		Client:        mgr.GetClient(),
		Scheme:        mgr.GetScheme(),
		MetricsClient: metricsClient,
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "Skale")
		os.Exit(1)
	}
